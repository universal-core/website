  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={clsx("dark:text-gray-0 text-gray-900")}>
            UniversalCore{" "}
          </div>
          <div
            className={clsx(
              "font-semibold",
              "dark:text-refine-purple dark:drop-shadow-[0_0_30px_rgba(167,139,245,0.25)]",
              "text-refine-purple drop-shadow-[0_0_30px_rgba(167,139,245,0.3)]",
              "whitespace-nowrap",
            )}
          >
            Blog
